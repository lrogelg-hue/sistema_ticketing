namespace TicketsSoporte.logica
{
    public class Ticket
    {
        ...
        {
            if (objTecnico == null) throw new InvalidOperationException("No se puede asignar un tecnico nulo.");
            if (!objTecnico.puedeAtender(strCategoria)) throw new InvalidOperationException("El tecnico no esta disponible o no atiende esta categoria.");
